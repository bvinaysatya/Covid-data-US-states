...
def plot_state(state, csvname, plotname):
    ...
    fig,ax = plt.subplots()
    ax.plot(get_values(state_res,'death'))
    ax.plot(get_values(state_res,'positive'))
    ax.plot(get_values(state_res,'hospitalized'))
